          ...
          {photo ? (
            <form className="admin-photos__editor" onSubmit={savePhoto}>
              <fieldset disabled={working}>
                ...
                <label>Alt text (optional)<input maxLength={500} value={photo.alt_text} onChange={(event) => updatePhoto('alt_text', event.target.value)} /></label>
                <p className="admin-page__hint">You can add a description for visitors using screen readers.</p>
